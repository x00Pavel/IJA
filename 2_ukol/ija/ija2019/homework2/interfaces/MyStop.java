...
/**
 * Reprezentuje zastávku. Zastávka má svůj unikátní identifikátor a dále
 * souřadnice umístění a zná ulici, na které je umístěna. Zastávka je jedinečná
 * svým identifikátorem. Reprezentace zastávky může existovat, ale nemusí mít
 * přiřazeno umístění (tj. je bez souřadnic a bez znalosti ulice). Pro shodu
 * objektů platí, že dvě zastávky jsou shodné, pokud mají stejný identifikátor.
 * 
 * @author koci
 */
public interface MyStop {

    public static Stop defaultStop(String id, Coordinate c){
        return Stop.defaultStop(id, c);
    }
